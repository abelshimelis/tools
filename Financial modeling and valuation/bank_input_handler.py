...
class InputHandler:
    ...
    def get_assumptions(self):
        ...
        if 'Total Loans (Ending, $mm)' in result and 'Loan Growth Rate (%)' in result:
            ...
            # Derive growth from actual loan balances: FY2026E → FY2027E change
            loans_26 = loans.get('FY2026E', 0)
            loans_27 = loans.get('FY2027E', 0)
            growth   = (loans_27 / loans_26 - 1) if loans_26 else 0
        ...
        if 'Avg. Earning Assets ($mm)' in result:
            ...
            base_25 = ea.get('FY2025E', 0)
            base_26 = ea.get('FY2026E', 0)
            base_27 = ea.get('FY2027E', 0)
            # Derive growth from FY2026E → FY2027E; fall back to FY2025E → FY2026E if needed
            if base_26 and base_27:
                growth_rate = base_27 / base_26 - 1
            elif base_25 and base_26:
                growth_rate = base_26 / base_25 - 1
            else:
                growth_rate = 0
